<?php
/**
 * Districts Handler — GET /api/districts
 *
 * Query params:
 *   regency     string  Regency code (XX.XX or XXXX)
 *   province    string  Province code (2 digits)
 *   limit       int     max 1000, default 100
 *   offset      int     default 0
 *
 * Note: District data comes from `wilayah` table (wilayah_level_1_2 only has levels 1-2).
 */
